        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-sm leading-relaxed text-[var(--brand-muted)]">
              Preencha o formulário abaixo com o produto e o link do anúncio da Shopee. Quando o cliente clicar no botão da oferta, ele será direcionado para o app ou site da Shopee usando a URL cadastrada.
            </p>
          </div>
          <AdminLogoutButton />
        </div>
